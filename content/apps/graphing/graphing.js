...
function findWasmBinary() {
  return locateFile('graphing.wasm');
}
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['flecs_explorer_request'] != 'undefined', 'missing Wasm export: flecs_explorer_request');
  ...
  assert(typeof wasmExports['dynCall_jiiji'] != 'undefined', 'missing Wasm export: dynCall_jiiji');
  ...
  _flecs_explorer_request = Module['_flecs_explorer_request'] = createExportWrapper('flecs_explorer_request', 3);
  ...
  dynCall_jiiji = dynCalls['jiiji'] = createExportWrapper('dynCall_jiiji', 5);
