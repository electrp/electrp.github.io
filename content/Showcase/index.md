...
{{< code language=cpp title="Slotmap Data Structure Implementation from NiteLite Engine Project (GAM300, Digipen)" isCollapsed="true" >}}
```cpp
/**
 *  @author Will Bender
 */
...
namespace NLE
{
    ...
    public:
        std::size_t operator()(const SlotKey<IndexType, GenerationType>& key) const
        {
            ...
            boost::hash_combine<IndexType>(seed, key.GetIndex());
            return seed;
        }
    };
